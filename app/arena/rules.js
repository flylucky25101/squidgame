...
export const ROUNDS = [
  ...
  [
    '정전 사냥터',
    '전원 장치 3개를 찾아 북쪽 출구로 탈출하세요. 손전등의 빛이 추적자를 유인합니다. 선반 뒤로 숨어 시야를 끊으세요.',
    240,
  ],
  [
    '줄다리기',
  ...
  [
    '붕괴하는 공장',
    '공장 끝까지 이동하세요. 중앙은 빠르지만 틈·압착기·붕괴 발판이 있습니다. 양옆 우회로는 안전합니다. SPACE / 행동 버튼으로 점프·올라가기.',
    300,
  ],
  [
    '유리다리',
  ...
  [
    '탈출 차량 추격전',
    '자동 가속 차량을 좌우로 조향해 600m 앞 탈출선으로! 아래로 당기면 감속, SPACE / 행동 버튼은 부스트. 중앙 봉쇄는 양옆으로 피하세요.',
    300,
  ],
];
